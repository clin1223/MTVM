...
class Param:
    def __init__(self):
        ...
        self.parser.add_argument('--num_process', type=int, default=2)
        ...
        self.parser.add_argument('--TestbatchSize', type=int, default=16)
        ...
        self.parser.add_argument("--adj_data_path", default=None)
        ...
        self.parser.add_argument('--distance_weight', type=float, default=0.3)
        self.parser.add_argument('--distance_weight_c', type=float, default=0.3)
        self.parser.add_argument('--drop_rate', type=float, default=0.3)
